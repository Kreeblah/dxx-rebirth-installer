...
begin
    ...
    if CurPageID = wpReady then begin
      ...
      // D1 Addons
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/raw/master/levelpacks/D1/D1%20Anarchy%20Ranger%20Pack.zip', expandconstant('{tmp}\d1-anarchy.zip'), 'd1xa\mission\rangeranarchy');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/raw/master/levelpacks/D1/D1%20Coop%20Ranger%20Pack.zip', expandconstant('{tmp}\d1-coop.zip'), 'd1xa\mission\rangercoop');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/raw/master/levelpacks/D1/dcl_d1_missions.zip', expandconstant('{tmp}\dcl_d1_missions.zip'), 'd1xa\mission\dcl');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1xr-sc55-music.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1xr-sc55-music.dxa'), 'd1xa\addon\sc55');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1xr-opl3-music.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1xr-opl3-music.dxa'), 'd1xa\addon\opl3');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1cda-mac.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1cda-mac.dxa'), 'd1xa\addon\mac');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1-playstation.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1-playstation.dxa'), 'd1xa\addon\playstation');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1midi-awe32.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1midi-awe32.dxa'), 'd1xa\addon\awe32');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1midi-awe64.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1midi-awe64.dxa'), 'd1xa\addon\awe64');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1midi-ensoniq2m.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1midi-ensoniq2m.dxa'), 'd1xa\addon\2m');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1midi-ensoniq8m.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1midi-ensoniq8m.dxa'), 'd1xa\addon\8m');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1midi-rolandsc.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1midi-rolandsc.dxa'), 'd1xa\addon\sc');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1-finn.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\Soundtracks\d1-finn.dxa'), 'd1xa\addon\finn');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d1xr-briefings-ger.dxa', expandconstant('{app}\DXX-Rebirth\D1X-Rebirth\d1xr-briefings-ger.dxa'), 'd1xa\addon\german');
      // D2 Addons
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2xr-maximum.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\d2xr-maximum.dxa'), 'd2xa\max');      
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/raw/master/levelpacks/D2/D2%20Anarchy%20Ranger%20Pack.zip', expandconstant('{tmp}\d2-anarchy.zip'), 'd2xa\mission\rangeranarchy');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/raw/master/levelpacks/D2/D2%20Coop%20Ranger%20Pack.zip', expandconstant('{tmp}\d2-coop.zip'), 'd2xa\mission\rangercoop');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/raw/master/levelpacks/D2/dcl_d2_missions.zip', expandconstant('{tmp}\dcl_d2_missions.zip'), 'd2xa\mission\dcl');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2xr-sc55-music.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2xr-sc55-music.dxa'), 'd2xa\addon\sc55');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2xr-opl3-music.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2xr-opl3-music.dxa'), 'd2xa\addon\opl3');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2cda-mac.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2cda-mac.dxa'), 'd2xa\addon\mac');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2midi-awe32.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2midi-awe32.dxa'), 'd2xa\addon\awe32');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2midi-awe64.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2midi-awe64.dxa'), 'd2xa\addon\awe64');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2midi-ensoniq2m.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2midi-ensoniq2m.dxa'), 'd2xa\addon\2m');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2midi-ensoniq8m.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2midi-ensoniq8m.dxa'), 'd2xa\addon\8m');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2midi-rolandsc.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2midi-rolandsc.dxa'), 'd2xa\addon\sc');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2-finn.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2-finn.dxa'), 'd2xa\addon\finn');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2cda-max.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2cda-max.dxa'), 'd2xa\addon\max');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2cda-tdc.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\Soundtracks\d2cda-tdc.dxa'), 'd2xa\addon\tdc');
      idpAddFileComp('https://github.com/Kreeblah/dxx-addons/releases/download/v1.0/d2xr-briefings-ger.dxa', expandconstant('{app}\DXX-Rebirth\D2X-Rebirth\d2xr-briefings-ger.dxa'), 'd2xa\addon\german');
